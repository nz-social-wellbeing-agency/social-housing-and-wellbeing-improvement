...
# 6 Dec 2018 Updated for Social Housing 3
# 5 Feb 2019 Updated for Containerization AK
# ================================================================================================ #
...
# Now we start generating weighted descriptive for the numeric values like income,sf12 mental and physical scores
source("5_of_weighted_descr_means.R")
