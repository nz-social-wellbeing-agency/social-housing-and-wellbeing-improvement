...
si_debug,False
si_pop_table_out,of_gss_hh_variables_sh3
si_id_col,snz_uid
si_asat_date,as_at_date
si_num_periods_before,-24
si_num_periods_after,12
...
idi_version,IDI_Clean_20181020
si_idi_dsnname,idi_sandpit_srvprd
;
run;
