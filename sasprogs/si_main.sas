...
%let si_source_path = /nas/DataLab/MAA/MAA2016-15 Supporting the Social Investment Unit/outcomes_framework/sh3;
...
options obs=MAX mvarsize=max pagesize=132
        append=(sasautos=("&si_source_path./lib/social_investment_data_foundation/sasautos"
						"&si_source_path./lib/social_investment_analytical_layer/SIAL_dependencies/sasautos"
...
/* Linking everyone in the houshold with admin data to get income, benefits and correction info*/
%include "&si_source_path./sasprogs/si_create_of_gss_ind_admin_variables.sas";
...
/* Combine all variables together from admin , hnz and gss household and indv.*/
%include "&si_source_path./sasprogs/si_create_of_gss_ind_wrapper.sas";

/* Add admin data characteristics to the GSS individuals */
%si_conditional_drop_table(si_cond_table_in=sand.gss_pop_char_sh3);
%si_get_characteristics_up(
idi_version=&idi_version.,
si_char_proj_schema=&si_proj_schema., 
	si_char_table_in=of_gss_ind_variables_sh3, 
	si_as_at_date=gss_pq_interview_date,
	si_char_table_out=sand.gss_pop_char_sh3);
