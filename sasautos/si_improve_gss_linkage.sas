...
/*							  si_table_out=of_gss_hh_variables_imp_sh3, */
...
/*Test*/
/*proc sql;*/
/*select count(distinct snz_uid), count(distinct snz_uid_original), gss_id_collection_code*/
/*from _temp_matching2 group by gss_id_collection_code ;*/
/*quit;*/
...
/*		**/
/*	from connection to odbc(	*/
/*			select m.snz_uid_new as snz_uid*/
/*				, p.**/
/*				FROM [IDI_Sandpit].[DL-MAA2016-15].[of_gss_hh_variables_sh3] p*/
/*				left join [IDI_Sandpit].[DL-MAA2016-15].of_gss_hh_matching m on p.snz_uid=m.snz_uid_original and p.gss_id_collection_code=m.gss_id_collection_code*/
/**/
/*	);*/
/**/
/*	disconnect from odbc;*/
